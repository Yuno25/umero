          ...
          <div className="flex gap-3 overflow-x-auto">
            {space.photos?.map((photo, i) => (
              <img
                ...
                className={`h-20 w-28 object-cover rounded-xl cursor-pointer
              ...
              <div className="border-t pt-4 mb-5">
                ...
                <div className="flex justify-between text-sm mb-2">
                  ...
                  <span className="font-semibold">
                    ■{Math.round(space.pricePerHour * 0.12)}
                  </span>
                </div>
                <div className="flex justify-between font-bold text-black mt-3">
                  <span>Total (per hour)</span>
                  <span>■{Math.round(space.pricePerHour * 1.12)}</span>
                </div>
              </div>
              <button
                className="w-full bg-black text-white py-3
 rounded-xl font-semibold text-sm hover:bg-gray-900
 transition"
              >
                Request to Book
              </button>
